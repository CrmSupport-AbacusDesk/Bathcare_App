                        ...
                        let updateAlert = this.alertCtrl.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    text: 'Update Now',
                                    handler: () => {
                                         window.open('market://details?id=com.bathcare.appk&hl=en','_system','location=yes');
                                        // window.open('https://play.google.com/store/apps/details?id=com.agmeco.abacusdesk&hl=en','_system','location=yes');
                                    }
