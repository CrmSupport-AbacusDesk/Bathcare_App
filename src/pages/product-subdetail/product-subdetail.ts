...
export class ProductSubdetailPage {
    ...
    user_data:any={};
    userType:any
    company_name:any='Agmeco Bathroom Fittings'
    url:any=''
            ...
            shareproduct()   {
                ...
                if(this.prod_image && this.prod_image.length > 0) {
                    ...
                    if(this.prod_image.length > 1) {
                        ...
                        // https://apps.abacusdesk.com/Respfaucet/dd_api/app/uploads
                        this.imgData=this.url+this.prod_detail.actual_image_name;
