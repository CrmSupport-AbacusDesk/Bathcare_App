...
export class HomePage {
    ...
    getofferBannerList()
    {
        ...
        notification()
        {
            ...
            this.socialSharing.share('Hey There ! here is an awesome app from bathcare  ..Give it a try https://play.google.com/store/apps/details?id=com.bathcare.app'+this.ref_code).then(() => {
                      ...
                      let updateAlert = this.alertCtrl.create({
                          ...
                          buttons: [
                              ...
                              },
                              {
                                  text: 'Update Now',
                                  handler: () => {
                                      window.open('https://play.google.com/store/apps/details?id=com.bathcare.abacusdesk&hl=en','_system','location=yes');
                                  }
